...
const navItems = [
    ...
    { label: "Marketplace", icon: Store, route: "/buyer/marketplace" },
    { label: "Bookings", icon: CalendarCheck, route: "/buyer/bookings" },
    { label: "Wishlist", icon: Heart, route: "/buyer/wishlist" },
    { label: "Payment", icon: CreditCard, route: "/buyer/payment" },
            ...
            <nav className="space-y-1" aria-label="Farmer sidebar">
                {navItems.map((item) => {
                    ...
                    const isActive =
                        ...
                        (item.route !== "/buyer/dashboard" && currentPath.startsWith(`${item.route}/`));
