import { LayoutGrid, Menu, Search, ShoppingCart, Store, UserCircle2 } from "lucide-react";
    ...
    return (
        <header className="w-full border-b border-slate-200 bg-white">
            <div className="flex h-16 w-full items-center gap-3 px-4 md:gap-6 md:px-6">
                <button
                    type="button"
                    onClick={() => window.dispatchEvent(new Event("toggle-buyer-sidebar"))}
            ...
            <div className="grid grid-cols-4 border-t border-slate-100 px-2 py-1 md:hidden">
                <button type="button" onClick={() => navigate("/buyer/dashboard")} className="grid place-items-center p-2 text-emerald-800">
                    <LayoutGrid className="h-4 w-4" />
                </button>
                <button type="button" onClick={() => navigate("/buyer/marketplace")} className="grid place-items-center p-2 text-emerald-800">
                    <Store className="h-4 w-4" />
                </button>
                <button type="button" onClick={() => navigate("/buyer/orders")} className="grid place-items-center p-2 text-emerald-800">
