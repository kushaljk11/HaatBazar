import { LayoutGrid, Leaf, Menu, Search, ShoppingCart, UserCircle2 } from "lucide-react";
    ...
    return (
        <header className="w-full border-b border-slate-200 bg-white">
            ...
            <div className="grid grid-cols-4 border-t border-slate-100 px-2 py-1 md:hidden">
                <button type="button" onClick={() => navigate("/farmer/dashboard")} className="grid place-items-center p-2 text-emerald-800">
                    <LayoutGrid className="h-4 w-4" />
                </button>
                <button type="button" onClick={() => navigate("/farmer/my-crops")} className="grid place-items-center p-2 text-emerald-800">
                    <Leaf className="h-4 w-4" />
                </button>
                <button type="button" onClick={() => navigate("/farmer/orders")} className="grid place-items-center p-2 text-emerald-800">
